...
public class SiteListActivity extends AppCompatActivity {
    ...
    private void initializeRecyclerView() {
        RecyclerView recyclerViewSiteList = (RecyclerView) findViewById(R.id.recycler_view_site);
        recyclerViewSiteList.setHasFixedSize(true);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerViewSiteList.setLayoutManager(layoutManager);
        recyclerViewAdapter = new SiteDetailAdapter(recyclerViewSiteList, this);
        recyclerViewSiteList.setAdapter(recyclerViewAdapter);
